...
namespace PayrollProcessor.Infrastructure.Seeding.Features.Generators
{
    ...
    {
        private readonly Faker<EmployeeDetails> employeeGenerator;
        ...
        public EmployeeSeed()
        {
            ...
            employeeGenerator = new DomainFaker<EmployeeDetails>(faker => new EmployeeDetails(Guid.NewGuid()))
        ...
        public IEnumerable<EmployeeDetails> BuildMany(int employeesCount, int payrollsMaxCount) =>
            employeeGenerator
